                    ...
                    <form class="panel needs-validation " method="post" action="{{ route('student.update', $student->id) }}" novalidate>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6"><label class="form-label" for="firstName"
                                    ...
                                    name="name" required value="{{ old('name', $student->name) }}">
                            ...
                            <div class="col-md-6"><label class="form-label" for="role">District</label><select
                                    ...
                                    <option value="1" {{ old('district',$student->district) == 1 ? 'selected' : '' }}>Dhaka</option>
                                    <option value="2" {{ old('district',$student->district) == 2 ? 'selected' : '' }}>Feni</option>
                                    <option value="3" {{ old('district',$student->district) == 3 ? 'selected' : '' }}>Chittagong</option>
                                    <option value="4" {{ old('district',$student->district) == 4 ? 'selected' : '' }}>Cumilla</option>
                                </select>
                            ...
                            <div class="col-md-6 d-block"><label class="form-label" for="team">Subject</label>
                                ...
                                <div class="form-check form-check-inline"><input class="form-check-input" type="checkbox"
                                        name="subjects[]" value="react"
                                        {{ old('subjects') == 'react' ? 'checked' : '' }}><label class="form-check-label"
                                        for="sampleCheck">React</label>
                                </div>
                                <div class="form-check form-check-inline"><input class="form-check-input" type="checkbox"
                                         name="subjects[]" value="mysql"
                                        {{ old('subjects[]') == 'mysql' ? 'checked' : '' }}><label
                                        class="form-check-label" for="sampleCheck">Mysql</label>
                                </div>
                                <div class="form-check form-check-inline"><input class="form-check-input" type="checkbox"
                                        name="subjects[]" value="laravel"
                                        {{ old('subjects') == 'laravel' ? 'checked' : '' }}><label
                                        class="form-check-label" for="sampleCheck" value="laravel">Laravel</label>
                                </div>
                        ...
                        <div class="d-flex flex-wrap justify-content-end gap-2 mt-4"><a class="btn btn-outline-secondary"
                                href="{{route('student.index')}}">Cancel</a><button class="btn btn-primary" type="submit"><i
